...
| Traktor Kontrol S3 | Partial | Windows HID discovery, raw event evidence, named button/jog/continuous-control decoding, session dispatch, reconnect retry, and provisional Play/Cue/Sync LED reports exist; controlled jog/touch and unplug/replug runs, TL-08 control application, audio routing, macOS, and native performance proof remain open | TL-07 |
