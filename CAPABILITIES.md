...
| Traktor Kontrol S3 | Partial | Windows HID discovery, raw event evidence, semantic button/jog/fader decoding, session dispatch, and provisional Play/Cue/Sync LED reports exist; controlled jog calibration, fader mapping, disconnect/reconnect, audio routing, macOS, and native performance proof remain open | TL-07 |
